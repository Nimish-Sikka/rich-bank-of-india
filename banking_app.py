...
#         st.write(f"Mobile Number: {user[5]}")
#         st.write(f"Aadhar Number: {user[6]}")
#         st.write(f"Balance: {user[7]} ₹")
#         st.write(f"Account Type: {user[8]}")
#     else:
...
#                 st.write(f"Date: {transaction[0]}, Type: {transaction[1]}, Amount: {transaction[2]} ₹, Balance After: {transaction[3]} ₹")
#         else:
...
# # Display the logo
# def display_logo():
#     logo = Image.open('images/logo.jpg')  # Make sure to put your logo image in the 'static' folder
#     st.image(logo, width=200)
#     st.title("RICH BANK OF INDIA (RBI)")
...
#     )
#     logo = Image.open('images/logo.png')  # Make sure to put your logo image in the 'images' folder
#     st.image(logo, width=200, use_column_width=True)
#     st.markdown('<h1 class="centered" style="color: #6D28D9;">RICH BANK OF INDIA (RBI)</h1>', unsafe_allow_html=True)
...
#     st.write(f"<h2 style='text-align: center; color: #1F2937;'>Your current balance is: {balance} ₹</h2>", unsafe_allow_html=True)
...
#     if user:
#         st.write("<h2 style='text-align: center; color: #6D28D9;'>--- Account Details ---</h2>", unsafe_allow_html=True)
...
#         if transactions:
#             st.write("<h2 style='text-align: center; color: #6D28D9;'>--- Transaction Report ---</h2>", unsafe_allow_html=True)
#             for transaction in transactions:
...
def display_logo():
    ...
    with col1:
        logo = Image.open('images/logo.png')  # Ensure the image is in the 'images' folder
